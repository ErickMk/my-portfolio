...
export default function ParticlesBackground({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={toggleTheme}
        className="fixed top-4 left-1/2 -translate-x-1/2 p-2 rounded-full bg-white/10 dark:bg-black/10 backdrop-blur-md border border-black/10 dark:border-white/10 text-black dark:text-white hover:bg-white/20 dark:hover:bg-black/20 transition-colors duration-300 z-[50]"
